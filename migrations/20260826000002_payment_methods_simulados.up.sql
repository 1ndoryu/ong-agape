-- Métodos de pago simulados para previsualizar el modal de la página de donar
-- antes de activarlos. Se amplía el CHECK de provider con los nuevos proveedores
-- y se insertan con status 'setup_required' (simulación): el frontend los marca
-- como no operativos y el backend los rechaza al enviar.
